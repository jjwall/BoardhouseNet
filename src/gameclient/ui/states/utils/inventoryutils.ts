import { DraggedItemData } from "../gameplay/inventoryslot";
 ...
 */
export function processItemSlotSwap(item: DraggedItemData, slotsMetaData: InventorySlotMetaData[], offsetX: number, offsetY: number): number {
