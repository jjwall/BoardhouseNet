...
const config: ClientConfig = {
    ...
    textureUrls: [
        ...
        // Page basic attack
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_00.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_01.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_02.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_03.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_04.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_05.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_06.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_07.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_08.png",
        "./assets/textures/page/basic_attack/Heroine_page_attack_slash_09.png",
