...
export const rangerAnim: AnimationSchema = {
    [SequenceTypes.IDLE]: [
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_00.png",
            nextFrame: 1
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_01.png",
            nextFrame: 2
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_02.png",
            nextFrame: 3
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_03.png",
            nextFrame: 4
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_04.png",
            nextFrame: 5
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_05.png",
            nextFrame: 6
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_06.png",
            nextFrame: 7
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_07.png",
            nextFrame: 8
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_08.png",
            nextFrame: 9
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_09.png",
            nextFrame: 10
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_10.png",
            nextFrame: 11
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_11.png",
            nextFrame: 12
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_12.png",
            nextFrame: 13
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_13.png",
            nextFrame: 14
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_14.png",
            nextFrame: 15
        },
        {
            ticks: 3,
            texture: "./assets/textures/ranger/idle/Heroine_ranger_idle_15.png",
            nextFrame: 0
        },
    ],
    [SequenceTypes.WALK]: [
